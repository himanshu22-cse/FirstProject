...
void AMain::SaveGame()
{
	UFirstSaveGame* SaveObject = Cast<UFirstSaveGame>(UGameplayStatics::CreateSaveGameObject(UFirstSaveGame::StaticClass())); // "StaticClass" will essentially do is return a value that's compatible with this TSubclassof "USaveGame".
